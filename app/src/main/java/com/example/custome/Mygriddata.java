...
public class Mygriddata extends BaseAdapter {
    private final int img[];
    private final String name[];
    Context context;

    public Mygriddata(Context context, int[] img1, String[] name1) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        View view1 = layoutInflater.inflate(R.layout.mygrid,null);
